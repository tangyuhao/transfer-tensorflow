...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        for _ in range(args.max_steps):
            _, lr_val, loss_val, cross_entropy_loss_val, jmmd_loss_val, accuracy_val, step_val, offset_val, scale_val = \
                sess.run(
                    [train_op, learning_rate, loss, cross_entropy_loss, jmmd_loss, accuracy, global_step, bw_offset, bw_scale])
