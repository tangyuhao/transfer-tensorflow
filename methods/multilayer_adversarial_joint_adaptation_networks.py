...
class MultilayerAdversarialJointAdaptationNetwork(BaseMethod):
    ...
    def __call__(self, inputs, labels, loss_weights, global_step):
        ...
        param_D = [D_src_feature_w1, D_src_feature_b1, D_src_feature_w2, D_src_feature_b2, D_tgt_feature_w1,
                   D_tgt_feature_b1, D_tgt_feature_w2, D_tgt_feature_b2, D_src_logits_w1, D_src_logits_b1,
        ...
        def discriminator_tgt_feature(x):
            ...
            h1 = tf.add(tf.matmul(x, D_tgt_feature_w1), D_tgt_feature_b1)
        ...
        def discriminator_src_logits(x):
            ...
            h1 = tf.add(tf.matmul(x, D_src_logits_w1), D_src_logits_b1)
        ...
        def discriminator_tgt_logits(x):
            ...
            h1 = tf.add(tf.matmul(x, D_tgt_logits_w1), D_tgt_logits_b1)
        ...
        return loss, accuracy, cross_entropy_loss, final_jmmd_loss, param_D, tf.reduce_max(
            target_logits), tf.reduce_mean(labels[1])
